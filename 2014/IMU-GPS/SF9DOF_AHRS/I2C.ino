...
//      AN[4] = ACC[1];
//      AN[5] = ACC[2];
//      Accl_Vector[0] = SENSOR_SIGN[3]*(ACC[0]-AN_OFFSET[3]);
//      Accl_Vector[1] = SENSOR_SIGN[4]*(ACC[1]-AN_OFFSET[4]);
//      Accl_Vector[2] = SENSOR_SIGN[5]*(ACC[2]-AN_OFFSET[5]);
//    }
//  else
...
//    Mgnt_Vector[0] = SENSOR_SIGN[6]*((((int)buff[2]) << 8) | buff[3]);    // X axis (internal sensor y axis)
//    Mgnt_Vector[1] = SENSOR_SIGN[7]*((((int)buff[0]) << 8) | buff[1]);    // Y axis (internal sensor x axis)
//    Mgnt_Vector[2] = SENSOR_SIGN[8]*((((int)buff[4]) << 8) | buff[5]);    // Z axis
//  }
//  else
